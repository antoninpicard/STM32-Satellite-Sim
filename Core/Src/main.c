...
/* ---- Mutex I2C (partage entre IMU, BMP, OLED) ---- */
...
/* ===================================================================
 *  Task_IMU — Lecture MPU-6050 (accel + gyro)
 *  Periodicite : 50ms (20 Hz)
 *  Prendre mutexI2C avant chaque acces I2C
 * =================================================================== */
void Task_IMU(void *argument)
{
  for (;;)
...
/* ===================================================================
 *  Task_BMP — Lecture BMP280 (temperature + pression)
 *  Periodicite : 500ms (2 Hz)
 *  Prendre mutexI2C avant chaque acces I2C
 * =================================================================== */
void Task_BMP(void *argument)
{
...
/* ===================================================================
 *  Task_Display — Affichage OLED SSD1306 + navigation joystick
 *  Periodicite : 100ms (10 Hz)
 *  Prendre mutexI2C avant chaque ecriture OLED
 * =================================================================== */
void Task_Display(void *argument)
{
  for (;;)
...
/* ===================================================================
 *  Task_Telemetry — Envoi telemetrie UART2 vers PC
 *  Periodicite : 200ms (5 Hz)
 *  Pas besoin de mutex (UART2 dedie)
 * =================================================================== */
void Task_Telemetry(void *argument)
{
  for (;;)
...
{
  /* USER CODE BEGIN 5 */
  /* defaultTask ne fait rien — toute la logique est dans les taches projet */
  for(;;)
  {
    osDelay(1000);
  }
